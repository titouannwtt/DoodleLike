        ...
        //console.log(feeds[i]);
         ...
         if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) { 
          if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
            ...
            feedHTML += '<a class="btn btn-primary btn-sm btn-twitter" href="https://twitter.com/'+tweetusername+'" target="_blank"><i class="fa fa-twitter"></i><span class="inner-txt"></span></a>';                                     
